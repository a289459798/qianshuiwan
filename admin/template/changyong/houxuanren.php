...
<table  cellpadding="0" cellspacing="1" class="table_list" width="100%">
  ...
  <tbody>
    <tr>
      <th colspan="6"><div align="left">&nbsp;&nbsp;<a href="__URL__/addHouxuan.html" target="_self">添加候选人</a></div></th>
    </tr>
    <tr>
      <th width="10%">ID</th>
      <th width="30%">名字</th>
    ...
    <tr>
      ...
      <td class="align_c">
	  <a  href="__URL__/editHouxuan-{$vo['id']}.html" target="_self">修改</a>&nbsp;&nbsp;|&nbsp;&nbsp;
	  <a  href="__URL__/delHouxuan-{$vo['id']}.html" target="_self" onClick="return confirm('确定要删除吗？')">删除</a>
	  </td>
    </tr>
    <?php }?>
  </tbody>
