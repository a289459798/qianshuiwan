...
<form name="add" action="__URL__/add" method="post"  onSubmit="return check_form(document.add);" >
  <table cellpadding="0" cellspacing="1" class="table_form">
    ...
    <tr>
      <th colspan="2"><div align="left"><strong><a href="__URL__/index-{$fenlei}.html" target="_self">返回法律法规</a></strong></div></th>
    </tr>
    <tr>
	...
	<tr>
      <th width="20%"> <font color="red">*</font> <strong>所属分类</strong> <br />      </th>
      <td>
		  <select name="fenlei">
			   <?php foreach($fname as $k=>$vo){ ?>    
					 <?php if($k==$info['fenlei']){ ?>
