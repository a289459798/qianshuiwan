...
<table  cellpadding="0" cellspacing="1" class="table_list" width="100%">
  <caption>
  关键词 <span style="color:#FF0000">{$keyword} </span>搜索结果  <a href="__URL__/index.html">返回法律法规</a>
  </caption>
  <tbody>
    <tr>
      <th colspan="7"><div align="left">&nbsp;&nbsp;<a href="__URL__/add.html" target="_self">发布法律法规</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="__URL__/index.html" target="_self">所有法律法规</a></div></th>
    </tr>
	   <tr>
    ...
    <tr>
      ...
      <tr>
        ...
        <td class="align_c">{$fname[$vo['fenlei']]}</td>
